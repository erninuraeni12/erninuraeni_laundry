		...
		<div class="row">
			<div class="col-md-12 col-sm-12 ">
				<div class="x_panel">
					...
					<div class="x_content">
						<br />
						<form action="../../routers/r_pelanggan.php?aksi=tambah" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
							...
							<div class="item form-group">
								<label for="role" class="col-form-label col-md-3 col-sm-3 label-align">Jenis kelamin</label>
								<div class="col-md-6 col-sm-6 ">
